...
Revision ID: 25aa2106d588
Revises: 
Create Date: 2023-11-06 09:48:11.416043
...
def upgrade():
    ...
    sa.Column('is_sexual_content', sa.Boolean(), nullable=False),
    sa.Column('is_violence', sa.Boolean(), nullable=False),
    sa.Column('is_child_abuse', sa.Boolean(), nullable=False),
    sa.ForeignKeyConstraint(['cache_id'], ['cache.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
